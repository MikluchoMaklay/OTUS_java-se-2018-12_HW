 ...
 * mvn package
 * java -cp ./target/HW1.0-maven.jar Main
 * java -jar ./target/HW1.0-maven.jar //java.lang.NoClassDefFoundError: com/google/common/collect/Lists
 * java -cp ./target/HW1.0-maven.jar;C:\Users\Michael\.m2\repository\com\google\guava\guava\25.0-jre\guava-25.0-jre.jar Main
 * <p>
 * To unzip the jar:
